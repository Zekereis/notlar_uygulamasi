...
class NotDetaySafa extends StatefulWidget {
  Notlar not;

  NotDetaySafa({required this.not});

  @override
  _NotDetaySafaState createState() => _NotDetaySafaState();
}

class _NotDetaySafaState extends State<NotDetaySafa> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          TextButton(onPressed: (){
            guncelle(widget.not.not_id, tfDersAdi.text, int.parse(tfnot1.text), int.parse(tfnot1.text));
          },
